...
function getSourceFile(routeId: string, appSurface: "CP" | "CLIENT"): string {
  ...
  if (appSurface === "CP") {
    const fileMap: Record<string, string> = {
      dashboard_cp: "apps/control-plane/src/surfaces/cp/dashboard.ts",
      tenants_cp: "apps/control-plane/src/surfaces/cp/tenants.ts",
      entitlements_cp: "apps/control-plane/src/surfaces/cp/entitlements.ts",
      pages_cp: "apps/control-plane/src/surfaces/cp/pages.ts",
      audit_cp: "apps/control-plane/src/surfaces/cp/audit.ts",
      access_denied_cp: "apps/control-plane/src/surfaces/cp/access-denied.ts",
      blocked_cp: "apps/control-plane/src/surfaces/cp/blocked.ts",
      notfound_cp: "apps/control-plane/src/surfaces/cp/notfound.ts",
      login_cp: "apps/control-plane/src/surfaces/cp/login.ts",
      account_cp: "apps/control-plane/src/surfaces/cp/registry.ts",
      settings_cp: "apps/control-plane/src/surfaces/cp/registry.ts",
    ...
    const fileMap: Record<string, string> = {
      home_app: "apps/control-plane/src/surfaces/app/home-app.ts",
      client_disabled_app: "apps/control-plane/src/surfaces/app/client-disabled.ts",
      access_denied_app: "apps/control-plane/src/surfaces/app/client-access-denied.ts",
      client_catalog_app: "apps/control-plane/src/surfaces/app/client-catalog.ts",
      pages_inventory_app: "apps/control-plane/src/surfaces/app/client-pages-inventory.ts",
      notfound_app: "apps/control-plane/src/surfaces/app/client-disabled.ts"
    };
    return fileMap[routeId] || "apps/control-plane/src/surfaces/app/registry.ts";
  }
}
