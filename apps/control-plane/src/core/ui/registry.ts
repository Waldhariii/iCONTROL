...
export const UI_COMPONENT_REGISTRY: UiComponentRegistryEntry[] = [
  { id: "button", sources: ["apps/control-plane/src/core/ui/button.ts"], classBase: "ic-btn", classHints: ["ic-btn--primary","ic-btn--secondary","ic-btn--danger","ic-btn--ghost"], datasets: [], allowedInlineStyles: [] },
  { id: "badge", sources: ["apps/control-plane/src/core/ui/badge.ts"], classBase: "ic-badge", datasets: ["data-tone"], allowedInlineStyles: [] },
  { id: "toolbar", sources: ["apps/control-plane/src/core/ui/toolbar.ts"], classBase: "ic-toolbar", classHints: ["ic-toolbar__search","ic-toolbar__actions","ic-toolbar__select"], allowedInlineStyles: [] },
  { id: "sectionCard", sources: ["apps/control-plane/src/core/ui/sectionCard.ts"], classBase: "ic-section-card", classHints: ["ic-section-card__header","ic-section-card__body"], allowedInlineStyles: [] },
  { id: "pageShell", sources: ["apps/control-plane/src/core/ui/pageShell.ts"], classBase: "ic-page-shell", classHints: ["ic-page-shell__header","ic-page-shell__content"], allowedInlineStyles: [] },
  { id: "dataTable", sources: ["apps/control-plane/src/core/ui/dataTable.ts"], classBase: "ic-table", classHints: ["ic-table__wrap","ic-table__table","ic-table__pagination"], allowedInlineStyles: [] },
  { id: "confirmModal", sources: ["apps/control-plane/src/core/ui/confirmModal.ts"], classBase: "ic-modal", classHints: ["ic-modal-overlay","ic-modal__actions"], allowedInlineStyles: [] },
  { id: "emptyState", sources: ["apps/control-plane/src/core/ui/emptyState.ts"], classBase: "ic-empty-state", classHints: ["ic-empty-card"], allowedInlineStyles: [] },
  { id: "errorState", sources: ["apps/control-plane/src/core/ui/errorState.ts"], classBase: "ic-error-state", classHints: ["ic-error-state__actions"], allowedInlineStyles: [] },
  { id: "toast", sources: ["apps/control-plane/src/core/ui/toast.ts", "modules/core-system/ui/frontend-ts/pages/_shared/uiBlocks.ts"], classBase: "ic-toast", datasets: ["data-status"], allowedInlineStyles: [] },
  { id: "skeletonLoader", sources: ["apps/control-plane/src/core/ui/skeletonLoader.ts"], classBase: "ic-skel", classHints: ["ic-skel__shimmer"], allowedInlineStyles: ["height"] },
