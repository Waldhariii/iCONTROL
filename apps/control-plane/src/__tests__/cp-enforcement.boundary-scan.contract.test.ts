...
describe("Governance: CP enforcement wiring stays boundary-safe", () => {
  it("bootstrap/wiring/facades do not import core-kernel directly", () => {
    ...
    const files = [
      path.join(root, "apps/control-plane/src/core/ports/cpEnforcement.wiring.ts"),
      path.join(root, "apps/control-plane/src/core/ports/cpEnforcement.bootstrap.ts"),
      path.join(root, "apps/control-plane/src/core/ports/activationRegistry.facade.ts"),
      path.join(root, "apps/control-plane/src/core/ports/policyEngine.facade.ts"),
    ];
