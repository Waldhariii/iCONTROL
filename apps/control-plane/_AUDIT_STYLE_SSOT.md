...
src/styles/tokens.generated.css:2: * Source: runtime/configs/ssot/design.tokens.json
...
src/core/ssot/tenantMatrixLoader.ts:2: * tenantMatrixLoader — TENANT_FEATURE_MATRIX (runtime/configs/ssot).
...
src/core/ssot/tenantMatrixLoader.ts.bak.20260128_142420:2: * tenantMatrixLoader — TENANT_FEATURE_MATRIX (runtime/configs/ssot).
...
src/policies/governance/docs/STANDARDS/README.md:9:- **Sémantique**: un kill-switch **désactive** un comportement, sans casser le flux fonctionnel.
src/policies/governance/docs/STANDARDS/README.md:39:## Invariants & Runtime Flags
src/policies/governance/docs/STANDARDS/README.md:41:### Sémantiques contract (cache)
src/policies/governance/docs/STANDARDS/README.md:42:- **ttlMs <= 0** : sémantique **no-expiry** (l’entrée est persistante tant qu’elle n’est pas invalidée / évincée).
src/policies/governance/docs/STANDARDS/README.md:59:- Toute extension “provider externe” doit rester **derrière un contrat** (ex: CacheProvider) et conserver ces invariants.
src/policies/governance/docs/STANDARDS/README.md:62:## SWR (stale-while-revalidate) — invariants (contract)
src/policies/governance/docs/STANDARDS/README.md:64:### Semantics
