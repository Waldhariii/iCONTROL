...
| 2.2 | Script auto-discovery : scan modules/**/manifest → registry modules, routing table, nav, permission matrix, entitlements catalog | Script Node ; sortie config/ssot ou artefact généré |
