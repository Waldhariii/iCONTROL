...
- Paths: `app/src/core/governance/rbac/policy.ts`, `config/permissions/rbac.json`
...
- Paths: `config/ssot/ROUTE_CATALOG.json`, `app/src/core/ssot/routeCatalogLoader.ts`, `app/src/router.ts`
...
- Paths: `config/ssot/ROUTE_CATALOG.json`, `config/ssot/TENANT_FEATURE_MATRIX.json`, `config/ssot/CAPABILITY_STATUS.json`
...
1) Tokens SSOT
- Paths: `config/ssot/design.tokens.json`, `app/src/styles/tokens.generated.css`
