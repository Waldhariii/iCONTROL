...
const specificMap = new Map([
  ...
  ["token_sets.json", "token_set.v1"],
  ["theme_layers.json", "array_of_objects.v1"],
  ["themes.json", "theme.v1"],
  ["typography_sets.json", "typography_set.v1"],
  ["density_profiles.json", "density_profile.v1"],
  ["motion_sets.json", "motion_set.v1"],
