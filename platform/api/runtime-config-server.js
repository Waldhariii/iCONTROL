 ...
 * SSOT is platform/api/dist/runtime-config-server.mjs (built from runtime-config-server.ts).
 * 
...
console.warn(
  "⚠️  WARNING: platform/api/runtime-config-server.js is deprecated. Using SSOT server instead.",
);
// eslint-disable-next-line no-console
console.warn(
  "   SSOT: platform/api/dist/runtime-config-server.mjs (built from runtime-config-server.ts)",
);
