...
writeFileSync(
  activationsPath,
  JSON.stringify([
    { tenant_id: "tenant:test", module_id: "module:documents", state: "active" }
  ], null, 2) + "\n"
);

const releaseId = "mod-docs-001";
...
if (!routes.includes("route:docs-list")) throw new Error("Docs routes missing");
if (routes.includes("route:jobs-list") || routes.includes("route:billing-invoices")) {
  throw new Error("Inactive module routes present");
}

console.log("Module activation documents PASS");
