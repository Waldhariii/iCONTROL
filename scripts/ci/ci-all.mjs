...
const steps = [
  ...
  "node scripts/ci/test-vertical-pack-smoke.mjs",
  "node scripts/ci/test-surface-contract.mjs",
  "node scripts/ci/test-widget-contract-pack.mjs",
  "node scripts/ci/test-extension-no-core-leak.mjs",
  "node scripts/ci/test-no-hardcoded-styles.mjs",
  "node scripts/ci/test-token-contrast-gate.mjs",
  "node scripts/ci/test-brand-source-any-hex.mjs",
  ...
  "node scripts/ci/test-action-export-pdf-end2end.mjs",
  "node scripts/ci/test-ocr-pipeline-local-stub.mjs",
