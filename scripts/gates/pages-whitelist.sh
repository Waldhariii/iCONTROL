...
ALLOW_APP_RE='^app/src/surfaces/app/(dashboard|login|clients|jobs|account|settings|home-app|client-access-denied|client-catalog|client-disabled|client-pages-inventory|registry)/Page\.tsx$'
