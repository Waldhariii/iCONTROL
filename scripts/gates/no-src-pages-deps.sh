...
# Fail if any runtime/prod code references app/src/pages (legacy) after migration.
# Allowed: _backups/**, docs/**, audit/evidence, tests, and scripts
ALLOW_RE='^(_backups/|docs/|_audit/|app/_audit_runs/|app/_AUDIT|app/_audit/|app/_EVIDENCE_STORE/|app/console_usages_report\.txt|app/\.eslintignore$|scripts/|app/src/__tests__/|app/src/.*__tests__/|.*\.test\.|PATHS_CANONICAL\.md$|\.)'
PATTERN='app/src/pages/|from\s+["'"'"']\./pages/|from\s+["'"'"']\.\./pages/|/pages/(app|cp)/|src/pages/(app|cp)/'
